    ...
    private:
        ...
        void eat() {
            if (funds >= HOUSE_EAT_COST) {
                std::cout << "🍽 Eating a meal... (3 seconds)\n";
                ...
                switch (choice) {
                    ...
                    case 2:
                        if (funds >= INTERMEDIATE_MEAL_COST) {
                            ...
                            std::cout << "🍽 Eating intermediate meal...\n";
                        } else {
                            std::cout << "❌ Not enough funds!\n";
                        }
                        break;
...
private:
    ...
    void viewStatistics() {
        ...
        cout << "🌫 Pollution Level: " << pollutionLevel << "\n";
        if (pollutionLevel < 0) {
        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                    ...
                    break;
                case 2:
                    cout << "\n🌫 " << currentUser << " and " << secondUser << " discuss pollution reduction:\n";
                ...
                case 7:
                    ...
                    if (payment < repayAmount) {
                        cout << "⚠ Partial payment made. You still owe " << (repayAmount - payment) << " funds.\n";
